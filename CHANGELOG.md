...
### Added
- (2026-02-24 UTC) Added a `New (N)` indicator on the header changelog button, showing how many release versions were added since the user's last changelog view.
