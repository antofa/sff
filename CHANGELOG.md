...
### Changed
- (2026-02-06 UTC) Automatically sync searched player decks into Supabase tables (`player_profiles`, `player_decks`, `player_deck_cards`, `cards`, and `player_fused_decks`) during `/api/decks` and `/api/decks/stream` requests.
